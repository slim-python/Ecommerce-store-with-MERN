            ...
            <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
              ...
              <div class="mt-8 lg:col-span-5">
                ...
                <button
                  ...
                  type="submit"
                  class="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-pink-400 py-3 px-8 text-base font-medium text-white hover:bg-pink-300 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                >
                  Submit Review
                </button>
              </div>
